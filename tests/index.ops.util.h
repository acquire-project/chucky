...
// Build lifted shape and strides for a tile decomposition (no codec alignment).
// The epoch dimension (dim 0) stride is set to 0 so all epochs collapse.
// storage_order may be NULL for identity order.
void
