...
struct bench_memory
{
  ...
  // The estimate is device memory, so device_used_bytes is what it should be
  // compared against — host growth measures something else entirely.
  int estimate_is_device_memory;
};
